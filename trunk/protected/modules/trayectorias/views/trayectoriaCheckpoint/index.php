...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . TrayectoriaCheckpoint::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo TrayectoriaCheckpoint::label(2) ?>    </legend>
