...
#
# Structure for table "trayectoria_etapa"
#

CREATE TABLE `trayectoria_etapa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  `peso` int(11) NOT NULL,
  `estado` enum('ACTIVO','INACTIVO') NOT NULL,
...
#
# Structure for table "trayectoria"
#
...
CREATE TABLE `trayectoria` (
  ...
  `peso_limite` int(11) NOT NULL,
  `usuario_creacion_id` int(11) NOT NULL,
  `fecha_creacion` datetime NOT NULL,
  `fecha_despacho` datetime DEFAULT NULL,
  `num_checkpoints` varchar(45) NOT NULL,
  `trayectoria_etapa_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_trayectoria_trayectoria_etapa1_idx` (`trayectoria_etapa_id`),
  CONSTRAINT `fk_trayectoria_trayectoria_etapa1` FOREIGN KEY (`trayectoria_etapa_id`) REFERENCES `trayectoria_etapa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1;

#
# Structure for table "trayectoria_checkpoint"
#

CREATE TABLE `trayectoria_checkpoint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `estado` enum('EN ESPERA','APROBADO') NOT NULL,
  `ciudad_id` int(11) NOT NULL,
  `usuario_actualizacion_id` int(11) NOT NULL,
  `fecha_actualizacion_id` datetime NOT NULL,
  `trayectoria_id` int(11) NOT NULL,
  `observaciones` text,
  PRIMARY KEY (`id`),
  KEY `fk_trayectoria_checkpoint_trayectoria1_idx` (`trayectoria_id`),
  CONSTRAINT `fk_trayectoria_checkpoint_trayectoria1` FOREIGN KEY (`trayectoria_id`) REFERENCES `trayectoria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

#
# Structure for table "trayectoria_producto"
#

CREATE TABLE `trayectoria_producto` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `trayectoria_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `cliente_origen_id` int(11) NOT NULL,
  `cliente_destino_id` int(11) NOT NULL,
  `ciudad_origen_id` int(11) NOT NULL,
  `ciudad_destino_id` int(11) NOT NULL,
  `fecha_creacion` datetime NOT NULL,
  `fecha_enviado` datetime DEFAULT NULL,
  `estado` enum('EN ESPERA','ENVIADO') DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_trayectoria_producto_trayectoria1_idx` (`trayectoria_id`),
  CONSTRAINT `fk_trayectoria_producto_trayectoria1` FOREIGN KEY (`trayectoria_id`) REFERENCES `trayectoria` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
