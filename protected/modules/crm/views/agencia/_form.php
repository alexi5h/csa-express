...
<div class="box box-solid box-primary">
    <div class="box-header">
        <h4 class="box-title"> <i class="fa fa-plus"></i> <?php echo Yii::t('AweCrud.app', $model->isNewRecord ? 'Create' : 'Update') . ' ' . Agencia::label(1); ?> </h4>
    ...
    <div class="box-body">
        ...
        <?php
        echo $form->switchGroup($model, 'matriz', array(
            'widgetOptions' => array(
                'options' => array(
                    'onText' => 'SI',
                    'offText' => 'NO'
