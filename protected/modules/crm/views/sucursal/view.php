...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Sucursal::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'agencia_id',
			'value'=>($model->agencia !== null) ? CHtml::link($model->agencia, array('/agencia/view', 'id' => $model->agencia->id)).' ' : null,
			'type' => 'html',
		),
             array(
			'name' => 'direccion_id',
