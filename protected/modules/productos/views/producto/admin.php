...
<div class="box box-solid box-primary">
    <div class="box-header">
        <h4 class="box-title"> <i class="fa fa-map-marker"></i> <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo Producto::label(2) ?> </h4>
        ...
        $this->widget('booster.widgets.TbGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'value' => 'isset($data->productoCategoria) ? $data->productoCategoria : null',
