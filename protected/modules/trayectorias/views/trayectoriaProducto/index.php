...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . TrayectoriaProducto::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo TrayectoriaProducto::label(2) ?>    </legend>
